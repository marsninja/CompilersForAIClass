...
| **Oct 6-8** | Memory Optimization<br>GPU Programming for AI |Papers and Discussion |  |
| **Oct 13-15** | Fall Study Break (Holiday)<br>TensorRT and Inference Optimization |Papers and Discussion |  |
| **Oct 20-22** | Large Language Model Optimization<br>Distributed Training Systems | Updates |  |
| **Oct 27-29** | Heterogeneous Computing<br>Hardware-Software Co-design | Updates |  |
| **Nov 3-5** | Emerging AI Chip Architectures<br>Emerging Techniques in AI Compilation |Papers and Discussion |  |
| **Nov 10-12** | Datacenter-scale AI Infrastructure<br>Project Presentations I | Papers and Discussion|  |
| **Nov 17-19** | Advanced Optimization Techniques<br>Guest Lectures | Papers and Discussion|  |
| **Nov 24-26** | Project Work Session<br>Thanksgiving Recess (Holiday) | Presentations |  |
...
| 2 | **DSPy** | **DSPy: Compiling Declarative Language Model Calls into Self-Improving Pipelines** | 2023 | [Paper](https://arxiv.org/pdf/2310.03714) |
...
| 4 | **DSPy** | **GEPA: Reflective Prompt Evolution Can Outperform Reinforcement Learning** | 2025 | [Paper](https://arxiv.org/abs/2507.19457) |
| 5 | **SGLang** | **SGLang: Efficient Execution of Structured Language Model Programs** | 2023 | [Paper](https://arxiv.org/abs/2312.07104) |
| 6 | **MTP** | **Meaning-Typed Programming: Language Abstraction and Runtime for Model-Integrated Applications** | 2025 | [Paper](https://arxiv.org/abs/2405.08965) |
| 7 | **vLLM** | **Efficient Memory Management for Large Language Model Serving with PagedAttention** | 2023 | [Paper](https://arxiv.org/abs/2309.06180) |
| 8 | **vLLM** | **Effective Memory Management for Serving LLM with Heterogeneity** | 2025 | [Paper](https://arxiv.org/abs/2503.18292) |
| 10 | **Apache TVM** | **TVM: An Automated End-to-End Optimizing Compiler for Deep Learning** | 2018 | [Paper](https://arxiv.org/abs/1802.04799) |
| 11 | **Apache TVM** | **Relay: A High-Level Compiler for Deep Learning** | 2019 | [Paper](https://arxiv.org/abs/1904.08368) |
| 12 | **Apache TVM** | **Ansor: Generating High-Performance Tensor Programs for Deep Learning** | 2020 | [Paper](https://arxiv.org/abs/2006.06762) |
| 13 | **PyTorch 2** | **PyTorch 2: Faster Machine Learning Through Dynamic Python Bytecode and Graph Compilation for DNNs** | 2024 | [Paper](https://dl.acm.org/doi/10.1145/3620665.3640366) |
| 14 | **PyTorch 2** | **TorchBench: Benchmarking PyTorch with High API Surface Coverage** | 2023 | [Paper](https://arxiv.org/abs/2304.14226) |
| 15 | **PyTorch 2** | **TorchTitan: One-stop PyTorch native solution for production ready LLM pretraining** | 2024 | [Paper](https://arxiv.org/abs/2410.06511) |
| 16 | **PyTorch ROCm** | **ECLIP: Energy-efficient and Practical Co-Location of ML Inference Pipelines on GPUs** | 2025 | [Paper](https://arxiv.org/abs/2506.12598) |
| 26 | **Triton** | **Triton: An Intermediate Language and Compiler for Tiled Neural Network Computations** | 2019 | [Paper](https://dl.acm.org/doi/10.1145/3315508.3329973) |
| 27 | **Triton** | **Geak: Introducing Triton Kernel AI Agent & Evaluation Benchmarks** | 2025 | [Paper](https://arxiv.org/abs/2507.23194) |
| 18 | **OpenXLA** | **Operator Fusion in XLA: Analysis and Evaluation** | 2023 | [Paper](https://arxiv.org/abs/2301.13062) |
| 19 | **OpenXLA** | **Memory Safe Computations with XLA Compiler** | 2022 | [Paper](https://arxiv.org/abs/2206.14148) |
| 23 | **Google MLIR** | **MLIR: A Compiler Infrastructure for the End of Moore's Law** | 2020 | [Paper](https://arxiv.org/abs/2002.11054) |
| 24 | **Meta Glow** | **Glow: Graph Lowering Compiler Techniques for Neural Networks** | 2018 | [Paper](https://arxiv.org/abs/1805.00907) |
| 31 | **GPU ISA & Architecture** | **Demystifying the Nvidia Ampere Architecture through Microbenchmarking and Instruction-level Analysis** | 2023 | [Paper](https://arxiv.org/abs/2208.11174) |
| 32 | **GPU ISA & Architecture** | **Cambricon: An Instruction Set Architecture for Neural Networks** | 2016 | [Paper](https://dl.acm.org/doi/10.1145/3331469) |
| 30 | **CUDA/ROCm** | **Optimizing sDTW for AMD GPUs** | 2024 | [Paper](https://arxiv.org/abs/2403.06931) |
| 33 | **TPU ISA & Architecture** | **TPU v4: An Optically Reconfigurable Supercomputer for Machine Learning with Hardware Support for Embeddings** | 2023 | [Paper](https://arxiv.org/abs/2304.01433) |
| 34 | **TPU ISA & Architecture** | **MTIA: First Generation Silicon Targeting Meta's Recommendation Systems** | 2023 | [Paper](https://dl.acm.org/doi/pdf/10.1145/3579371.3589348) |
| 35 | **TPU ISA & Architecture** | **Machine Learning Fleet Efficiency: Analyzing and Optimizing Large-Scale Google TPU Systems with ML Productivity Goodput** | 2016 | [Paper](https://arxiv.org/pdf/2502.06982) |
| 20 | **OpenVINO** | **OpenVINO Deep Learning Workbench: Comprehensive Analysis and Tuning of Neural Networks Inference** | 2019 | [Paper](https://openaccess.thecvf.com/content_ICCVW_2019/papers/SDL-CV/Gorbachev_OpenVINO_Deep_Learning_Workbench_Comprehensive_Analysis_and_Tuning_of_Neural_ICCVW_2019_paper.pdf) |
| 21 | **OpenVINO** | **Leveraging Speculative Sampling and KV-Cache Optimizations Together for Generative AI using OpenVINO** | 2023 | [Paper](https://arxiv.org/abs/2311.04951) |
| 25 | **Intel PlaidML** | **Stripe: Tensor Compilation via the Nested Polyhedral Model** | 2019 | [Paper](https://arxiv.org/abs/1903.06498) |
